...
using namespace std;
//https://russianblogs.com/article/64672229769/ ссылка на статью
...
public:
    ...
    vector<Texture> textures_loaded;	//храним уже загруженные текстуры для оптимизации
    vector<Mesh> meshes;
    string directory;
    ...
    void Load_model(string const& path)
    {
        ...
        //проходим по дереву, которое создал assimp
    ...
    Mesh Process_mesh(aiMesh* mesh, const aiScene* scene)
    {
        ...
        for (unsigned int i = 0; i < mesh->mNumVertices; i++)
        {
            ...
            // координааты тектур, если они есть
            if (mesh->mTextureCoords[0]) 
            {
                ...
                vertex.TextureCoordinats = vec;
            }
            else
                vertex.TextureCoordinats = glm::vec2(0.0f, 0.0f);
    ...
    // если не грузили такую текстуру, то грузим
